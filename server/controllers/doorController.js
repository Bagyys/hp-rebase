...
exports.getDoor1 = async (req, res) => {
  const data = req.query;
  const doorID = req.query.id;
  ...
  try {
    ...
    // console.log(n2, "n2");
    let n3 = updatedDoor.door.n3;
    let o1 = updatedDoor.door.o1.value;
    // console.log(o1, "o1");
    let o2 = updatedDoor.door.o2.value;
    let o3 = updatedDoor.door.o3;
    let e = updatedDoor.door.e;
...
exports.doorSwitch1 = async (req, res) => {
  ...
  try {
    ...
    if (data.o1 != undefined && data.open != undefined && data.o1 == 1) {
      // ar praeina
      ...
      switchDoor = await Door.findOneAndUpdate(
        ...
        {
          $set: {
            "door.o1.value": data.o1,
            "door.o1.open": data.open,
          },
        },
        { new: true }
      );
    ...
    if (data.o2 != undefined && data.open != undefined) {
      switchDoor = await Door.findOneAndUpdate(
        { doorID: doorID },
        {
          $set: {
            "door.o2.value": data.o2.value,
            "door.o2.open": data.o2.open,
          },
        },
        { new: true }
      );
    ...
    let o1 = switchDoor.door.o1.value;
    let o2 = switchDoor.door.o2.value;
